...
{
	if (region.j.bs === region.h.bs)
	{
		return 'on line ' + region.j.bs;
	}
	return 'on lines ' + region.j.bs + ' through ' + region.h.bs;
}
...
function _VirtualDom_makeCallback(eventNode, initialHandler)
{
	function callback(event)
	{
		...
		var stopPropagation = tag == 1 ? value.b : tag == 3 && value.gi;
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { fp: 'hidden', e_: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { fp: 'mozHidden', e_: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { fp: 'msHidden', e_: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { fp: 'webkitHidden', e_: 'webkitvisibilitychange' }
		: { fp: 'hidden', e_: 'visibilitychange' };
}
...
var $rtfeldman$elm_css$Css$auto = {eE: 0, c: 0, aW: 0, b_: 0, fx: 0, a$: 0, aj: 0, _: 0, a5: 0, V: 0, cs: 0, bc: 0, M: 0, ez: 'auto'};
...
var $rtfeldman$elm_css$Css$prop1 = F2(
	function (key, arg) {
		return A2($rtfeldman$elm_css$Css$property, key, arg.ez);
	});
var $rtfeldman$elm_css$Css$center = $rtfeldman$elm_css$Css$prop1('center');
var $rtfeldman$elm_css$Css$row = {cO: 0, bo: 0, ez: 'row'};
...
var $author$project$Style$Center$centerStyle = {
	dy: $rtfeldman$elm_css$Css$batch(
		_List_fromArray(
			[
	...
	dR: $rtfeldman$elm_css$Css$batch(
		_List_fromArray(
			[
				$rtfeldman$elm_css$Css$displayFlex,
				$rtfeldman$elm_css$Css$justifyContent($rtfeldman$elm_css$Css$center),
...
var $rtfeldman$elm_css$Css$Media$feature = F2(
	function (key, _v0) {
		...
		return {
			ff: key,
			ez: $elm$core$Maybe$Just(value)
		};
	});
var $rtfeldman$elm_css$Css$Media$maxWidth = function (value) {
	return A2($rtfeldman$elm_css$Css$Media$feature, 'max-width', value);
};
var $author$project$Style$Theme$useWidth = {
	a_: $rtfeldman$elm_css$Css$px(1000),
	a2: $rtfeldman$elm_css$Css$px(750),
	a6: $rtfeldman$elm_css$Css$px(550),
	aN: $rtfeldman$elm_css$Css$px(1200),
	cz: $rtfeldman$elm_css$Css$px(1800)
};
...
var $author$project$Style$Theme$useDevice = {
	a_: $rtfeldman$elm_css$Css$Media$withMedia(
		_List_fromArray(
			[
				$rtfeldman$elm_css$Css$Media$all(
				_List_fromArray(
					[
						$rtfeldman$elm_css$Css$Media$maxWidth($author$project$Style$Theme$useWidth.a_)
					]))
			])),
	a2: $rtfeldman$elm_css$Css$Media$withMedia(
		_List_fromArray(
			[
				$rtfeldman$elm_css$Css$Media$all(
				_List_fromArray(
					[
						$rtfeldman$elm_css$Css$Media$maxWidth($author$project$Style$Theme$useWidth.a2)
					]))
			])),
	a6: $rtfeldman$elm_css$Css$Media$withMedia(
		_List_fromArray(
			[
				$rtfeldman$elm_css$Css$Media$all(
				_List_fromArray(
					[
						$rtfeldman$elm_css$Css$Media$maxWidth($author$project$Style$Theme$useWidth.a6)
					]))
			])),
	aN: $rtfeldman$elm_css$Css$Media$withMedia(
		_List_fromArray(
			[
				$rtfeldman$elm_css$Css$Media$all(
				_List_fromArray(
					[
						$rtfeldman$elm_css$Css$Media$maxWidth($author$project$Style$Theme$useWidth.aN)
					]))
			])),
	cz: $rtfeldman$elm_css$Css$Media$withMedia(
		_List_fromArray(
			[
				$rtfeldman$elm_css$Css$Media$all(
				_List_fromArray(
					[
						$rtfeldman$elm_css$Css$Media$maxWidth($author$project$Style$Theme$useWidth.cz)
					]))
			]))
};
var $author$project$Style$Container$containerStyle = $rtfeldman$elm_css$Css$batch(
	_List_fromArray(
		[
			$rtfeldman$elm_css$Css$maxWidth($author$project$Style$Theme$useWidth.aN),
			A2(
			$rtfeldman$elm_css$Css$margin2,
			$rtfeldman$elm_css$Css$px(0),
			$rtfeldman$elm_css$Css$auto),
			$author$project$Style$Theme$useDevice.aN(
			_List_fromArray(
				[
					A2(
...
var $author$project$Content$Type$Content = F2(
	function (field, value) {
		return {dG: field, ez: value};
	});
var $author$project$Content$Type$ContentAsset = function (a) {
	return {$: 1, a: a};
};
var $author$project$Content$Type$ContentGrid = function (a) {
	return {$: 4, a: a};
};
var $author$project$Content$Type$ContentHero = function (a) {
	return {$: 2, a: a};
};
var $author$project$Content$Type$ContentIframe = function (a) {
	return {$: 3, a: a};
};
var $author$project$Content$Type$ContentMarkdown = function (a) {
	return {$: 0, a: a};
};
var $author$project$Content$Type$ContentUnknown = {$: 5};
var $author$project$Content$Type$HeroContent = function (asset) {
	return {eT: asset};
};
var $author$project$Content$Type$IframeContent = F3(
	function (source, title, ratio) {
		return {fZ: ratio, gf: source, er: title};
	});
...
var $author$project$Content$Type$AssetContent = F5(
	function (path, title, width, height, colors) {
		return {e2: colors, fn: height, fS: path, er: title, gD: width};
	});
			...
			if (_v3.a.$ === 1) {
				...
				if (_v3.b.b.$ === 1) {
					...
					return _Utils_Tuple3(
						...
						$elm$core$Result$Ok(
							_Utils_Tuple2(
								_Utils_ap(res.n, warnAcc),
								A2($elm$core$List$cons, res.ez, valAcc))));
				}
			}
		});
	return function (json) {
...
var $dillonkearns$elm_pages$OptimizedDecoder$Pipeline$custom = $dillonkearns$elm_pages$OptimizedDecoder$andMap;
...
var $dillonkearns$elm_pages$OptimizedDecoder$fail = function (message) {
	return A2(
		$dillonkearns$elm_pages$Internal$OptimizedDecoder$OptimizedDecoder,
...
var $dillonkearns$elm_pages$OptimizedDecoder$null = function (val) {
	return A2(
		$dillonkearns$elm_pages$Internal$OptimizedDecoder$OptimizedDecoder,
		$elm$json$Json$Decode$null(val),
		$zwilias$json_decode_exploration$Json$Decode$Exploration$null(val));
};
var $dillonkearns$elm_pages$OptimizedDecoder$oneOf = function (decoders) {
	var jds = A2(
		$elm$core$List$map,
		function (_v1) {
			var jd = _v1.a;
	...
	return A2(
		$dillonkearns$elm_pages$Internal$OptimizedDecoder$OptimizedDecoder,
		$elm$json$Json$Decode$oneOf(jds),
		$zwilias$json_decode_exploration$Json$Decode$Exploration$oneOf(jdes));
};
...
var $dillonkearns$elm_pages$OptimizedDecoder$value = A2($dillonkearns$elm_pages$Internal$OptimizedDecoder$OptimizedDecoder, $elm$json$Json$Decode$value, $zwilias$json_decode_exploration$Json$Decode$Exploration$value);
var $dillonkearns$elm_pages$OptimizedDecoder$Pipeline$optionalDecoder = F3(
	function (pathDecoder, valDecoder, fallback) {
		var nullOr = function (decoder) {
			return $dillonkearns$elm_pages$OptimizedDecoder$oneOf(
				_List_fromArray(
					[
						decoder,
						$dillonkearns$elm_pages$OptimizedDecoder$null(fallback)
					]));
		};
		var handleResult = function (input) {
			var _v0 = A2($dillonkearns$elm_pages$OptimizedDecoder$decodeValue, pathDecoder, input);
			if (!_v0.$) {
				var rawValue = _v0.a;
				var _v1 = A2(
					$dillonkearns$elm_pages$OptimizedDecoder$decodeValue,
					nullOr(valDecoder),
					rawValue);
				if (!_v1.$) {
					var finalResult = _v1.a;
					return $dillonkearns$elm_pages$OptimizedDecoder$succeed(finalResult);
				} else {
					var finalErr = _v1.a;
					return $dillonkearns$elm_pages$OptimizedDecoder$fail(
						$dillonkearns$elm_pages$OptimizedDecoder$errorToString(finalErr));
				}
			} else {
				return $dillonkearns$elm_pages$OptimizedDecoder$succeed(fallback);
			}
		};
		return A2($dillonkearns$elm_pages$OptimizedDecoder$andThen, handleResult, $dillonkearns$elm_pages$OptimizedDecoder$value);
	});
var $dillonkearns$elm_pages$OptimizedDecoder$Pipeline$optional = F4(
	function (key, valDecoder, fallback, decoder) {
		return A2(
			$dillonkearns$elm_pages$OptimizedDecoder$Pipeline$custom,
			A3(
				$dillonkearns$elm_pages$OptimizedDecoder$Pipeline$optionalDecoder,
				A2($dillonkearns$elm_pages$OptimizedDecoder$field, key, $dillonkearns$elm_pages$OptimizedDecoder$value),
				valDecoder,
				fallback),
			decoder);
	});
...
var $author$project$Content$Decoder$assetDecoder = A4(
	$dillonkearns$elm_pages$OptimizedDecoder$Pipeline$optional,
	'colors',
		...
		A3(
			...
			A3(
				...
				A3(
					...
					'path',
					$dillonkearns$elm_pages$OptimizedDecoder$string,
					$dillonkearns$elm_pages$OptimizedDecoder$succeed($author$project$Content$Type$AssetContent))))));
var $author$project$Content$Type$Field = F2(
	function (fieldType, label) {
		return {dH: fieldType, dX: label};
	});
var $author$project$Content$Decoder$fieldDecoder = A3(
	$dillonkearns$elm_pages$OptimizedDecoder$Pipeline$required,
	'label',
	$dillonkearns$elm_pages$OptimizedDecoder$string,
	A3(
		...
		'type',
		$dillonkearns$elm_pages$OptimizedDecoder$string,
		$dillonkearns$elm_pages$OptimizedDecoder$succeed($author$project$Content$Type$Field)));
var $author$project$Content$Type$GridAsset = function (a) {
	return {$: 1, a: a};
};
var $author$project$Content$Type$GridColumn = function (a) {
	return {$: 2, a: a};
};
var $author$project$Content$Type$GridContent = F2(
	function (field, value) {
		return {dG: field, ez: value};
	});
var $author$project$Content$Type$GridMarkdown = function (a) {
	return {$: 0, a: a};
};
var $author$project$Content$Type$GridUnknown = {$: 3};
function $author$project$Content$Decoder$cyclic$gridContentDecoder() {
	return A2(
		$dillonkearns$elm_pages$OptimizedDecoder$Pipeline$custom,
		A2(
			$dillonkearns$elm_pages$OptimizedDecoder$andThen,
			function (field) {
				var _v0 = _Utils_Tuple2(field.dH, field.dX);
				_v0$3:
				while (true) {
					switch (_v0.a) {
						case 'markdown':
							return A3(
								...
								'value',
								$dillonkearns$elm_pages$OptimizedDecoder$string,
								$dillonkearns$elm_pages$OptimizedDecoder$succeed($author$project$Content$Type$GridMarkdown));
						case 'asset':
							return A3(
								$dillonkearns$elm_pages$OptimizedDecoder$Pipeline$required,
								'value',
								$author$project$Content$Decoder$assetDecoder,
								$dillonkearns$elm_pages$OptimizedDecoder$succeed($author$project$Content$Type$GridAsset));
						case 'repeater':
							if (_v0.b === 'Column') {
								return A3(
									$dillonkearns$elm_pages$OptimizedDecoder$Pipeline$required,
									...
									$dillonkearns$elm_pages$OptimizedDecoder$list(
										$author$project$Content$Decoder$cyclic$gridContentDecoder()),
									$dillonkearns$elm_pages$OptimizedDecoder$succeed($author$project$Content$Type$GridColumn));
							} else {
								break _v0$3;
							}
						default:
				...
				return $dillonkearns$elm_pages$OptimizedDecoder$succeed($author$project$Content$Type$GridUnknown);
			},
			A2($dillonkearns$elm_pages$OptimizedDecoder$field, 'field', $author$project$Content$Decoder$fieldDecoder)),
		A3(
			$dillonkearns$elm_pages$OptimizedDecoder$Pipeline$required,
			'field',
			$author$project$Content$Decoder$fieldDecoder,
			$dillonkearns$elm_pages$OptimizedDecoder$succeed($author$project$Content$Type$GridContent)));
}
var $author$project$Content$Decoder$gridContentDecoder = $author$project$Content$Decoder$cyclic$gridContentDecoder();
$author$project$Content$Decoder$cyclic$gridContentDecoder = function () {
	return $author$project$Content$Decoder$gridContentDecoder;
};
var $author$project$Content$Decoder$contentDecoder = A2(
	$dillonkearns$elm_pages$OptimizedDecoder$Pipeline$custom,
	A2(
		$dillonkearns$elm_pages$OptimizedDecoder$andThen,
		function (field) {
				...
				switch (_v0.a) {
					case 'markdown':
						return A3(
							...
							'value',
							$dillonkearns$elm_pages$OptimizedDecoder$string,
							$dillonkearns$elm_pages$OptimizedDecoder$succeed($author$project$Content$Type$ContentMarkdown));
					case 'asset':
						return A3(
							$dillonkearns$elm_pages$OptimizedDecoder$Pipeline$required,
							'value',
							$author$project$Content$Decoder$assetDecoder,
							$dillonkearns$elm_pages$OptimizedDecoder$succeed($author$project$Content$Type$ContentAsset));
					case 'repeater':
						if (_v0.b === 'Grid') {
							return A3(
								$dillonkearns$elm_pages$OptimizedDecoder$Pipeline$required,
								'value',
								$dillonkearns$elm_pages$OptimizedDecoder$list($author$project$Content$Decoder$gridContentDecoder),
								$dillonkearns$elm_pages$OptimizedDecoder$succeed($author$project$Content$Type$ContentGrid));
						} else {
							break _v0$5;
						}
					case 'set':
							...
							case 'Hero':
								return A3(
									...
									A3(
										...
										'image',
										$author$project$Content$Decoder$assetDecoder,
										$dillonkearns$elm_pages$OptimizedDecoder$succeed($author$project$Content$Type$HeroContent)),
									$dillonkearns$elm_pages$OptimizedDecoder$succeed($author$project$Content$Type$ContentHero));
							case 'Iframe':
								return A3(
									$dillonkearns$elm_pages$OptimizedDecoder$Pipeline$required,
									'value',
									A3(
										...
										A3(
											...
											A3(
												...
												'src',
												$dillonkearns$elm_pages$OptimizedDecoder$string,
												$dillonkearns$elm_pages$OptimizedDecoder$succeed($author$project$Content$Type$IframeContent)))),
									$dillonkearns$elm_pages$OptimizedDecoder$succeed($author$project$Content$Type$ContentIframe));
							default:
								break _v0$5;
						}
					default:
			...
			return $dillonkearns$elm_pages$OptimizedDecoder$succeed($author$project$Content$Type$ContentUnknown);
		},
		A2($dillonkearns$elm_pages$OptimizedDecoder$field, 'field', $author$project$Content$Decoder$fieldDecoder)),
	A3(
		$dillonkearns$elm_pages$OptimizedDecoder$Pipeline$required,
		'field',
		$author$project$Content$Decoder$fieldDecoder,
		$dillonkearns$elm_pages$OptimizedDecoder$succeed($author$project$Content$Type$Content)));
	...
	function (declaration, _v0) {
		...
		switch (declaration.$) {
			...
			case 6:
				...
				return $elm$core$String$isEmpty(record.e4) ? _Utils_Tuple2(keyframesByName, declarations) : _Utils_Tuple2(
					A3($elm$core$Dict$insert, record.cY, record.e4, keyframesByName),
					declarations);
			case 7:
				var properties = declaration.a;
				return $elm$core$List$isEmpty(properties) ? _Utils_Tuple2(keyframesByName, declarations) : _Utils_Tuple2(
...
var $rtfeldman$elm_css$Css$Structure$compactStylesheet = function (_v0) {
	var charset = _v0.dw;
	var imports = _v0.dP;
	var namespaces = _v0.d$;
	var declarations = _v0.e5;
	var _v1 = A3(
		$elm$core$List$foldr,
	...
	return {dw: charset, e5: finalDeclarations, dP: imports, d$: namespaces};
};
...
var $rtfeldman$elm_css$ElmCssVendor$Murmur3$HashData = F4(
	function (shift, seed, hash, charsProcessed) {
		return {aS: charsProcessed, aZ: hash, aF: seed, a7: shift};
	});
...
var $rtfeldman$elm_css$ElmCssVendor$Murmur3$finalize = function (data) {
	var acc = (!(!data.aZ)) ? (data.aF ^ A2(
		...
		A2(
			...
			15,
			A2($rtfeldman$elm_css$ElmCssVendor$Murmur3$multiplyBy, $rtfeldman$elm_css$ElmCssVendor$Murmur3$c1, data.aZ)))) : data.aF;
	var h0 = acc ^ data.aS;
...
var $rtfeldman$elm_css$ElmCssVendor$Murmur3$hashFold = F2(
	function (c, data) {
		var res = data.aZ | ((255 & $elm$core$Char$toCode(c)) << data.a7);
		var _v0 = data.a7;
		if (_v0 === 24) {
			return {
				aS: data.aS + 1,
				aZ: 0,
				aF: A2($rtfeldman$elm_css$ElmCssVendor$Murmur3$mix, data.aF, res),
				a7: 0
			};
		} else {
			return {aS: data.aS + 1, aZ: res, aF: data.aF, a7: data.a7 + 8};
		}
	});
...
var $rtfeldman$elm_css$Css$Preprocess$Resolve$toStructure = function (_v0) {
	...
	var declarations = $rtfeldman$elm_css$Css$Preprocess$Resolve$extract(
		A2($elm$core$List$concatMap, $rtfeldman$elm_css$Css$Preprocess$unwrapSnippet, snippets));
	return {dw: charset, e5: declarations, dP: imports, d$: namespaces};
};
...
var $rtfeldman$elm_css$Css$Preprocess$stylesheet = function (snippets) {
	return {dw: $elm$core$Maybe$Nothing, dP: _List_Nil, d$: _List_Nil, ei: snippets};
};
...
var $author$project$Element$Asset$cssSourceMedia = function (expression) {
	return '(' + (expression.ff + (': ' + (A2($elm$core$Maybe$withDefault, '', expression.ez) + ')')));
};
var $rtfeldman$elm_css$Css$block = {o: 0, ez: 'block'};
var $rtfeldman$elm_css$Css$display = $rtfeldman$elm_css$Css$prop1('display');
var $rtfeldman$elm_css$Css$height = $rtfeldman$elm_css$Css$prop1('height');
var $author$project$Style$Image$imageStyle = $rtfeldman$elm_css$Css$batch(
	_List_fromArray(
		[
...
var $author$project$Image$useImageAPI = F2(
	function (src, width) {
		return '/image/api' + (src + ('?w=' + ($elm$core$String$fromInt(width) + '&o=1&q=60&m=fitToWidth')));
	});
var $author$project$Element$Asset$useImageAPISrcSet = F2(
	function (src, size) {
		return A2($author$project$Image$useImageAPI, src, size) + (' ' + ($elm$core$String$fromInt(size) + 'w'));
	});
var $author$project$Element$Asset$picture = F3(
	function (sizes, content, maybeStyles) {
		return A3(
				...
				[
					...
					_List_fromArray(
						[
							...
							$author$project$Element$Asset$cssSourceMedia(
								$rtfeldman$elm_css$Css$Media$maxWidth($author$project$Style$Theme$useWidth.a6))),
							A2($rtfeldman$elm_css$Html$Styled$Attributes$attribute, 'sizes', '90vw'),
							A2(
							$rtfeldman$elm_css$Html$Styled$Attributes$attribute,
							'srcset',
							A2($author$project$Element$Asset$useImageAPISrcSet, content.fS, sizes.a6))
						]),
					_List_Nil),
					A2(
					$rtfeldman$elm_css$Html$Styled$source,
					_List_fromArray(
						[
							...
							$rtfeldman$elm_css$Html$Styled$Attributes$attribute,
							'srcset',
							A2($author$project$Element$Asset$useImageAPISrcSet, content.fS, sizes.a2))
						]),
					_List_Nil),
					A2(
					$rtfeldman$elm_css$Html$Styled$source,
					_List_fromArray(
						[
							...
							$rtfeldman$elm_css$Html$Styled$Attributes$attribute,
							'srcset',
							A2($author$project$Element$Asset$useImageAPISrcSet, content.fS, sizes.a_))
						]),
					_List_Nil),
					A2(
					$rtfeldman$elm_css$Html$Styled$source,
					_List_fromArray(
						[
							$rtfeldman$elm_css$Html$Styled$Attributes$media(
							$author$project$Element$Asset$cssSourceMedia(
								$rtfeldman$elm_css$Css$Media$maxWidth($author$project$Style$Theme$useWidth.aN)) + (', ' + $author$project$Element$Asset$cssSourceMedia(
								$rtfeldman$elm_css$Css$Media$minWidth($author$project$Style$Theme$useWidth.aN)))),
							A2($rtfeldman$elm_css$Html$Styled$Attributes$attribute, 'sizes', '90vw'),
							A2(
							$rtfeldman$elm_css$Html$Styled$Attributes$attribute,
							'srcset',
							A2($author$project$Element$Asset$useImageAPISrcSet, content.fS, sizes.aN))
						]),
					_List_Nil),
					A2(
					...
					_List_fromArray(
						[
							$rtfeldman$elm_css$Html$Styled$Attributes$alt(content.er),
							$rtfeldman$elm_css$Html$Styled$Attributes$src(
							A2($author$project$Image$useImageAPI, content.fS, 900)),
							A2($rtfeldman$elm_css$Html$Styled$Attributes$attribute, 'loading', 'lazy'),
							function () {
							if (!maybeStyles.$) {
								var styles = maybeStyles.a;
								return $rtfeldman$elm_css$Html$Styled$Attributes$css(
									$elm$core$List$concat(
										_List_fromArray(
											[
												_List_fromArray(
												[$author$project$Style$Image$imageStyle]),
												styles
											])));
							} else {
								return $rtfeldman$elm_css$Html$Styled$Attributes$css(
...
var $author$project$Element$Asset$asset = {
	e6: F2(
		function (content, maybeStyle) {
			var landscape = _Utils_cmp(content.gD, content.fn) > 0;
			return A3(
				$author$project$Element$Asset$picture,
				A3(
					$author$project$Is$is,
					landscape,
					{a_: 900, a2: 700, a6: 500, aN: 1200, cz: 1200},
					{a_: 600, a2: 700, a6: 500, aN: 900, cz: 900}),
				content,
				A3(
					$author$project$Is$is,
					landscape,
					...
					$elm$core$Maybe$Just(
						$elm$core$List$concat(
							_List_fromArray(
								[
									A2($elm$core$Maybe$withDefault, _List_Nil, maybeStyle),
									_List_fromArray(
									[
										$rtfeldman$elm_css$Css$maxWidth(
	...
	dL: function (count) {
		return $author$project$Element$Asset$picture(
			{a_: (1000 / count) | 0, a2: 700, a6: 500, aN: (1200 / count) | 0, cz: (1200 / count) | 0});
	},
	dM: $author$project$Element$Asset$picture(
		{a_: 900, a2: 700, a6: 500, aN: 1400, cz: 1800})
};
...
var $author$project$Element$Empty$emptyElement = $rtfeldman$elm_css$Html$Styled$text('');
...
var $author$project$Element$Grid$gridItem = $rtfeldman$elm_css$Css$batch(
	_List_fromArray(
		[
			$rtfeldman$elm_css$Css$width(
			$rtfeldman$elm_css$Css$pct(50)),
			$author$project$Style$Theme$useDevice.a2(
			_List_fromArray(
				[
					$rtfeldman$elm_css$Css$width(
					$rtfeldman$elm_css$Css$pct(100))
				])),
			$author$project$Style$Center$centerStyle.dy
		]));
...
var $rtfeldman$elm_css$Css$int = function (val) {
	return {
		...
		bd: '',
		bB: 0,
		ez: $elm$core$String$fromInt(val)
	};
};
var $rtfeldman$elm_css$Css$italic = {aX: 0, ez: 'italic'};
...
var $author$project$Element$Link$handleHref = F2(
	function (href, attributes) {
		return $elm$core$List$concat(
			A3(
				$author$project$Is$is,
				A2($elm$core$String$startsWith, 'https://', href) || A2($elm$core$String$startsWith, 'http://', href),
				_List_fromArray(
					[
						attributes,
						_List_fromArray(
...
var $rtfeldman$elm_css$Css$none = {aQ: 0, dq: 0, F: 0, c: 0, o: 0, fq: 0, dS: 0, cS: 0, a1: 0, az: 0, _: 0, f: 0, d: 0, c_: 0, cd: 0, fV: 0, V: 0, ci: 0, f9: 0, ba: 0, aL: 0, M: 0, l: 0, gz: 0, ez: 'none'};
...
var $rtfeldman$elm_css$Css$absolute = {bv: 0, ez: 'absolute'};
...
var $rtfeldman$elm_css$Css$hidden = {F: 0, a5: 0, ez: 'hidden', bD: 0};
var $rtfeldman$elm_css$Css$left = $rtfeldman$elm_css$Css$prop1('left');
var $rtfeldman$elm_css$Css$position = $rtfeldman$elm_css$Css$prop1('position');
var $rtfeldman$elm_css$Css$relative = {bv: 0, ez: 'relative'};
...
var $rtfeldman$elm_css$Css$Transitions$fullTransition = F4(
	function (animation, duration, delay, timing) {
		return {
			bH: animation,
			bQ: $elm$core$Maybe$Just(delay),
			e9: duration,
			cv: $elm$core$Maybe$Just(timing)
		};
	});
var $rtfeldman$elm_css$Css$Transitions$visibility3 = $rtfeldman$elm_css$Css$Transitions$fullTransition(92);
var $rtfeldman$elm_css$Css$visible = {a5: 0, V: 0, ez: 'visible', bD: 0};
var $rtfeldman$elm_css$Css$Transitions$Width = 93;
var $rtfeldman$elm_css$Css$Transitions$width3 = $rtfeldman$elm_css$Css$Transitions$fullTransition(93);
var $author$project$Style$Underline$underlineStyle = function (themeColor) {
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								A3($rtfeldman$elm_css$Css$Transitions$visibility3, 400, 0, $rtfeldman$elm_css$Css$Transitions$easeInOut),
								A3($rtfeldman$elm_css$Css$Transitions$width3, 400, 0, $rtfeldman$elm_css$Css$Transitions$easeInOut)
							])),
...
var $rtfeldman$elm_css$Css$backgroundColor = function (c) {
	return A2($rtfeldman$elm_css$Css$property, 'background-color', c.ez);
};
var $rtfeldman$elm_css$Css$color = function (c) {
	return A2($rtfeldman$elm_css$Css$property, 'color', c.ez);
};
...
var $rtfeldman$elm_css$Css$erroneousHex = function (str) {
	return {
		...
		cP: 0,
		c3: 0,
		ez: $rtfeldman$elm_css$Css$withPrecedingHash(str)
	};
};
...
var $author$project$Style$Theme$useColor = {
	ce: $rtfeldman$elm_css$Css$hex('#FFF'),
	gb: $rtfeldman$elm_css$Css$hex('#000'),
	ct: $rtfeldman$elm_css$Css$hex('#6A971F')
};
var $author$project$Style$Theme$useColorTheme = {
	ce: $rtfeldman$elm_css$Css$batch(
		_List_fromArray(
			[
				$rtfeldman$elm_css$Css$backgroundColor($author$project$Style$Theme$useColor.ce),
				$rtfeldman$elm_css$Css$color($author$project$Style$Theme$useColor.gb)
			])),
	gb: $rtfeldman$elm_css$Css$batch(
		_List_fromArray(
			[
				$rtfeldman$elm_css$Css$backgroundColor($author$project$Style$Theme$useColor.ce),
				$rtfeldman$elm_css$Css$color($author$project$Style$Theme$useColor.ct)
			])),
	ct: $rtfeldman$elm_css$Css$batch(
		_List_fromArray(
			[
				$rtfeldman$elm_css$Css$backgroundColor($author$project$Style$Theme$useColor.ct),
				$rtfeldman$elm_css$Css$color($author$project$Style$Theme$useColor.ce)
			]))
};
var $author$project$Element$Link$link = {
	ce: F2(
		function (href, attributes) {
			return A3(
				...
				_List_fromArray(
					[
						$author$project$Style$Theme$useColorTheme.ce,
						$author$project$Style$Underline$underlineStyle($author$project$Style$Theme$useColorTheme.ct)
					]),
				A2($author$project$Element$Link$handleHref, href, attributes));
		}),
	gb: F2(
		function (href, attributes) {
			return A3(
	...
	ct: F2(
		function (href, attributes) {
			return A3(
				...
				_List_fromArray(
					[
						$author$project$Style$Theme$useColorTheme.ct,
						$rtfeldman$elm_css$Css$textDecoration($rtfeldman$elm_css$Css$none),
						...
						_List_fromArray(
							[$author$project$Style$Theme$useColorTheme.ce])),
						$author$project$Style$Theme$useDevice.a6(
						_List_fromArray(
							[
								$rtfeldman$elm_css$Css$padding(
								$rtfeldman$elm_css$Css$px(0)),
...
var $author$project$Element$Markdown$textToId = function (text) {
...
var $rtfeldman$elm_css$Css$num = function (val) {
	return {
		...
		bd: '',
		bB: 0,
		ez: $elm$core$String$fromFloat(val)
	};
};
var $author$project$Style$Theme$useTypography = {
	a_: $rtfeldman$elm_css$Css$batch(
		_List_fromArray(
			[
	...
	a2: $rtfeldman$elm_css$Css$batch(
		_List_fromArray(
			[
				$rtfeldman$elm_css$Css$fontSize(
	...
	a6: $rtfeldman$elm_css$Css$batch(
		_List_fromArray(
			[
				$rtfeldman$elm_css$Css$fontSize(
				$rtfeldman$elm_css$Css$px(10)),
				$author$project$Style$Theme$useColorTheme.gb
			])),
	aN: $rtfeldman$elm_css$Css$batch(
		_List_fromArray(
			[
				$rtfeldman$elm_css$Css$fontSize(
				$rtfeldman$elm_css$Css$px(27)),
				$rtfeldman$elm_css$Css$fontWeight(
	...
	cz: $rtfeldman$elm_css$Css$batch(
		_List_fromArray(
			[
				$rtfeldman$elm_css$Css$fontSize(
...
var $author$project$Element$Markdown$markdownRenderer = {
	eV: $rtfeldman$elm_css$Html$Styled$blockquote(
		_List_fromArray(
			[
	...
	fb: $rtfeldman$elm_css$Html$Styled$em(
		_List_fromArray(
			[
				$rtfeldman$elm_css$Html$Styled$Attributes$css(
				_List_fromArray(
	...
	fk: A2($rtfeldman$elm_css$Html$Styled$br, _List_Nil, _List_Nil),
	fm: function (_v1) {
		var level = _v1.fB;
		var rawText = _v1.f_;
		var children = _v1.e$;
				...
				return A2(
					...
					_List_fromArray(
						[
							...
							$author$project$Element$Markdown$textToId(rawText)),
							$rtfeldman$elm_css$Html$Styled$Attributes$css(
							_List_fromArray(
								[$author$project$Style$Theme$useTypography.cz]))
						]),
					children);
			case 1:
				return A2(
					...
					_List_fromArray(
						[
							...
							$rtfeldman$elm_css$Html$Styled$Attributes$css(
							_List_fromArray(
								[$author$project$Style$Theme$useTypography.aN]))
						]),
					children);
			case 2:
				return A2(
					...
					_List_fromArray(
						[
							...
							$rtfeldman$elm_css$Html$Styled$Attributes$css(
							_List_fromArray(
								[$author$project$Style$Theme$useTypography.a_, $author$project$Style$Theme$useColorTheme.gb]))
						]),
					children);
			case 3:
				return A2(
	...
	fr: $dillonkearns$elm_markdown$Markdown$Html$oneOf(_List_Nil),
	fs: function (_v3) {
		return A2($rtfeldman$elm_css$Html$Styled$div, _List_Nil, _List_Nil);
	},
	fD: F2(
		function (att, content) {
			...
			if (!_v4.$) {
				var title = _v4.a;
				return A3(
					$author$project$Element$Link$link.ce,
					att.dC,
					_List_fromArray(
						[
				...
				return A3($author$project$Element$Link$link.ce, att.dC, _List_Nil, content);
			}
		}),
	fQ: F2(
		function (_v5, _v6) {
	...
	fR: $rtfeldman$elm_css$Html$Styled$p(
		_List_fromArray(
			[
				$rtfeldman$elm_css$Html$Styled$Attributes$css(
				_List_fromArray(
					[$author$project$Style$Theme$useTypography.a2]))
			])),
	gj: $rtfeldman$elm_css$Html$Styled$del(_List_Nil),
	gk: $rtfeldman$elm_css$Html$Styled$strong(_List_Nil),
	gm: $rtfeldman$elm_css$Html$Styled$table(_List_Nil),
	gn: $rtfeldman$elm_css$Html$Styled$tbody(_List_Nil),
	go: F2(
		function (_v7, _v8) {
			return A2($rtfeldman$elm_css$Html$Styled$div, _List_Nil, _List_Nil);
		}),
	gp: $rtfeldman$elm_css$Html$Styled$thead(_List_Nil),
	gq: F2(
		function (_v9, _v10) {
			return A2($rtfeldman$elm_css$Html$Styled$div, _List_Nil, _List_Nil);
		}),
	gr: $rtfeldman$elm_css$Html$Styled$tr(_List_Nil),
	gt: function (content) {
		return $rtfeldman$elm_css$Html$Styled$text(content);
	},
	gu: A2($rtfeldman$elm_css$Html$Styled$hr, _List_Nil, _List_Nil),
	gx: function (_v11) {
		return A2($rtfeldman$elm_css$Html$Styled$div, _List_Nil, _List_Nil);
	}
};
...
var $dillonkearns$elm_markdown$Markdown$Parser$addReference = F2(
	function (state, linkRef) {
		return {
			aB: A2($elm$core$List$cons, linkRef, state.aB),
			ab: state.ab
		};
	});
...
var $elm$parser$Parser$Advanced$chompWhileHelp = F5(
	function (isGood, offset, row, col, s0) {
		chompWhileHelp:
		while (true) {
			var newOffset = A3($elm$parser$Parser$Advanced$isSubChar, isGood, offset, s0.da);
			if (_Utils_eq(newOffset, -1)) {
				return A3(
					$elm$parser$Parser$Advanced$Good,
					_Utils_cmp(s0.b, offset) < 0,
					0,
					{dx: col, g: s0.g, cQ: s0.cQ, b: offset, f6: row, da: s0.da});
			} else {
...
var $elm$parser$Parser$Advanced$chompWhile = function (isGood) {
	return function (s) {
		return A5($elm$parser$Parser$Advanced$chompWhileHelp, isGood, s.b, s.f6, s.dx, s);
	};
};
...
var $elm$parser$Parser$Advanced$DeadEnd = F4(
	function (row, col, problem, contextStack) {
		return {dx: col, e3: contextStack, fX: problem, f6: row};
	});
var $elm$parser$Parser$Advanced$fromState = F2(
	function (s, x) {
		return A2(
			...
			A4($elm$parser$Parser$Advanced$DeadEnd, s.f6, s.dx, x, s.g));
	});
...
var $elm$parser$Parser$Advanced$token = function (_v0) {
	...
	return function (s) {
		var _v1 = A5($elm$parser$Parser$Advanced$isSubString, str, s.b, s.f6, s.dx, s.da);
		var newOffset = _v1.a;
		var newRow = _v1.b;
		var newCol = _v1.c;
		return _Utils_eq(newOffset, -1) ? A2(
			...
			progress,
			0,
			{dx: newCol, g: s.g, cQ: s.cQ, b: newOffset, f6: newRow, da: s.da});
	};
};
		...
		return function (s0) {
			...
			if (_v1.$ === 1) {
				...
				return A3(
					...
					A2(
						func,
						A3($elm$core$String$slice, s0.b, s1.b, s0.da),
						a),
					s1);
			}
		};
...
var $elm$parser$Parser$Advanced$chompIf = F2(
	function (isGood, expecting) {
		return function (s) {
			var newOffset = A3($elm$parser$Parser$Advanced$isSubChar, isGood, s.b, s.da);
			return _Utils_eq(newOffset, -1) ? A2(
				$elm$parser$Parser$Advanced$Bad,
				false,
				...
				true,
				0,
				{dx: 1, g: s.g, cQ: s.cQ, b: s.b + 1, f6: s.f6 + 1, da: s.da}) : A3(
				$elm$parser$Parser$Advanced$Good,
				true,
				0,
				{dx: s.dx + 1, g: s.g, cQ: s.cQ, b: newOffset, f6: s.f6, da: s.da}));
		};
	});
...
var $elm$parser$Parser$Advanced$run = F2(
	function (_v0, src) {
		var parse = _v0;
		var _v1 = parse(
			{dx: 1, g: _List_Nil, cQ: 1, b: 0, f6: 1, da: src});
		if (!_v1.$) {
			var value = _v1.b;
			...
			return A3(
				...
				F2(
					function (headerCell, alignment) {
						return {bG: alignment, dX: headerCell};
					}),
				headers,
				columnAlignments);
		};
...
var $dillonkearns$elm_markdown$Markdown$Parser$completeOrMergeBlocks = F2(
	function (state, newRawBlock) {
		return {
			aB: state.aB,
			ab: function () {
				var _v0 = _Utils_Tuple2(newRawBlock, state.ab);
				_v0$9:
				while (true) {
					if (_v0.b.b) {
						switch (_v0.b.a.$) {
								...
								if (_v0.a.$ === 5) {
									...
									return A2(
										...
										$dillonkearns$elm_markdown$Markdown$RawBlock$CodeBlock(
											{
												eX: A2($dillonkearns$elm_markdown$Markdown$Parser$joinStringsPreserveAll, block2.eX, block1.eX),
				...
				return A2($elm$core$List$cons, newRawBlock, state.ab);
			}()
		};
	});
...
var $dillonkearns$elm_markdown$Markdown$Parser$deadEndToString = function (deadEnd) {
	return 'Problem at row ' + ($elm$core$String$fromInt(deadEnd.f6) + ('\n' + $dillonkearns$elm_markdown$Markdown$Parser$problemToString(deadEnd.fX)));
};
...
var $elm$parser$Parser$Advanced$chompUntilEndOr = function (str) {
	return function (s) {
		var _v0 = A5(_Parser_findSubString, str, s.b, s.f6, s.dx, s.da);
		var newOffset = _v0.a;
		var newRow = _v0.b;
		var newCol = _v0.c;
		var adjustedOffset = (newOffset < 0) ? $elm$core$String$length(s.da) : newOffset;
		return A3(
			$elm$parser$Parser$Advanced$Good,
			_Utils_cmp(s.b, adjustedOffset) < 0,
			0,
			{dx: newCol, g: s.g, cQ: s.cQ, b: adjustedOffset, f6: newRow, da: s.da});
	};
};
...
var $dillonkearns$elm_markdown$Markdown$InlineParser$matchToInline = function (_v0) {
	...
	switch (_v1.$) {
		case 0:
			return $dillonkearns$elm_markdown$Markdown$Inline$Text(match.gt);
		case 1:
			return $dillonkearns$elm_markdown$Markdown$Inline$HardLineBreak;
		case 2:
			return $dillonkearns$elm_markdown$Markdown$Inline$CodeInline(match.gt);
		case 3:
			var _v2 = _v1.a;
			var text = _v2.a;
			var url = _v2.b;
...
var $dillonkearns$elm_markdown$Markdown$InlineParser$prepareChildMatch = F2(
	function (parentMatch, childMatch) {
		return {h: childMatch.h - parentMatch.u, s: childMatch.s, j: childMatch.j - parentMatch.u, gt: childMatch.gt, D: childMatch.D - parentMatch.u, u: childMatch.u - parentMatch.u, m: childMatch.m};
	});
...
var $elm$regex$Regex$Match = F4(
	function (match, index, number, submatches) {
		return {a: index, a3: match, fL: number, dc: submatches};
	});
...
var $dillonkearns$elm_markdown$Markdown$InlineParser$normalMatch = function (text) {
	return {
		...
		s: _List_Nil,
		j: 0,
		gt: $dillonkearns$elm_markdown$Markdown$Helpers$formatStr(text),
		D: 0,
		u: 0,
...
var $dillonkearns$elm_markdown$Markdown$InlineParser$parseTextMatch = F3(
	function (rawText, _v2, parsedMatches) {
		...
		var updtMatch = {
			h: matchModel.h,
			s: A3($dillonkearns$elm_markdown$Markdown$InlineParser$parseTextMatches, matchModel.gt, _List_Nil, matchModel.s),
			j: matchModel.j,
			gt: matchModel.gt,
			D: matchModel.D,
			u: matchModel.u,
...
var $dillonkearns$elm_markdown$Markdown$InlineParser$regMatchToAngleBracketLToken = function (regMatch) {
	...
	if ((_v0.b && _v0.b.b) && (!_v0.b.a.$)) {
		...
		return $dillonkearns$elm_markdown$Markdown$Helpers$isEven(backslashesLength) ? $elm$core$Maybe$Just(
			{a: regMatch.a + backslashesLength, cT: 1, e: $dillonkearns$elm_markdown$Markdown$InlineParser$AngleBracketOpen}) : $elm$core$Maybe$Nothing;
	} else {
		return $elm$core$Maybe$Nothing;
	}
};
...
var $dillonkearns$elm_markdown$Markdown$InlineParser$regMatchToCodeToken = function (regMatch) {
	...
	if ((_v0.b && _v0.b.b) && (!_v0.b.a.$)) {
		...
		return $elm$core$Maybe$Just(
			{
				a: regMatch.a + backslashesLength,
				cT: $elm$core$String$length(backtick),
	...
	while (true) {
		if (_v0.b) {
			if (!_v0.a.$) {
				...
				return (!$dillonkearns$elm_markdown$Markdown$Helpers$isEven(backslashesLength)) ? $elm$core$Maybe$Just(
					{a: (regMatch.a + backslashesLength) - 1, cT: 2, e: $dillonkearns$elm_markdown$Markdown$InlineParser$HardLineBreakToken}) : $elm$core$Maybe$Nothing;
			} else {
				if (_v0.b.b && (!_v0.b.a.$)) {
					var _v1 = _v0.b;
					return $elm$core$Maybe$Just(
						{
							a: regMatch.a,
							cT: $elm$core$String$length(regMatch.a3),
	...
	while (true) {
		if (_v0.b) {
			if (!_v0.a.$) {
				...
				var backslashesLength = $elm$core$String$length(backslashes);
				return $dillonkearns$elm_markdown$Markdown$Helpers$isEven(backslashesLength) ? $elm$core$Maybe$Just(
					{a: regMatch.a + backslashesLength, cT: 1, e: $dillonkearns$elm_markdown$Markdown$InlineParser$HardLineBreakToken}) : $elm$core$Maybe$Just(
					{a: (regMatch.a + backslashesLength) - 1, cT: 2, e: $dillonkearns$elm_markdown$Markdown$InlineParser$HardLineBreakToken});
			} else {
				if (_v0.b.b) {
					var _v1 = _v0.b;
...
var $dillonkearns$elm_markdown$Markdown$InlineParser$regMatchToLinkImageCloseToken = function (regMatch) {
	...
	if ((_v0.b && _v0.b.b) && (!_v0.b.a.$)) {
		...
		var backslashesLength = A2(
			...
			A2($elm$core$Maybe$map, $elm$core$String$length, maybeBackslashes));
		return $dillonkearns$elm_markdown$Markdown$Helpers$isEven(backslashesLength) ? $elm$core$Maybe$Just(
			{a: regMatch.a + backslashesLength, cT: 1, e: $dillonkearns$elm_markdown$Markdown$InlineParser$SquareBracketClose}) : $elm$core$Maybe$Nothing;
	} else {
		return $elm$core$Maybe$Nothing;
	}
};
...
var $dillonkearns$elm_markdown$Markdown$InlineParser$regMatchToLinkImageOpenToken = function (regMatch) {
	...
	if (((_v0.b && _v0.b.b) && _v0.b.b.b) && (!_v0.b.b.a.$)) {
		...
		if (isEscaped) {
			...
			if (!maybeImageOpen.$) {
				return $elm$core$Maybe$Just(
					{a: index, cT: 2, e: $dillonkearns$elm_markdown$Markdown$InlineParser$ImageOpenToken});
			} else {
				return $elm$core$Maybe$Just(
					{
						a: index,
...
var $dillonkearns$elm_markdown$Markdown$InlineParser$regMatchToStrikethroughToken = function (regMatch) {
	...
	if ((_v0.b && _v0.b.b) && (!_v0.b.a.$)) {
		...
		var meaning = _v2.b;
		return $elm$core$Maybe$Just(
			{a: regMatch.a + backslashesLength, cT: length, e: meaning});
	} else {
		return $elm$core$Maybe$Nothing;
	}
};
...
var $dillonkearns$elm_markdown$Markdown$InlineParser$autolinkToMatch = function (_v0) {
	var match = _v0;
	return A2($elm$regex$Regex$contains, $dillonkearns$elm_markdown$Markdown$InlineParser$urlRegex, match.gt) ? $elm$core$Result$Ok(
		_Utils_update(
			match,
			{
				m: $dillonkearns$elm_markdown$Markdown$InlineParser$AutolinkType(
					_Utils_Tuple2(
						match.gt,
						$dillonkearns$elm_markdown$Markdown$InlineParser$encodeUrl(match.gt)))
...
var $dillonkearns$elm_markdown$Markdown$InlineParser$refRegexToMatch = F3(
	function (matchModel, references, maybeRegexMatch) {
		var refLabel = function (str) {
			return $elm$core$String$isEmpty(str) ? matchModel.gt : str;
		}(
			A2(
				$elm$core$Maybe$withDefault,
				matchModel.gt,
		...
		if (_v0.$ === 1) {
			...
			var regexMatchLength = function () {
				if (!maybeRegexMatch.$) {
					var match = maybeRegexMatch.a.a3;
			...
			return $elm$core$Maybe$Just(
				_Utils_update(
					matchModel,
					{h: matchModel.h + regexMatchLength, m: type_}));
		}
	});
		...
		if ((((_v0.b && _v0.b.b) && _v0.b.b.b) && _v0.b.b.b.b) && _v0.b.b.b.b.b) {
			...
			var toMatch = function (rawUrl) {
				return _Utils_update(
					matchModel,
					{
						h: matchModel.h + $elm$core$String$length(regexMatch.a3),
						m: function () {
...
var $dillonkearns$elm_markdown$Markdown$InlineParser$emailAutolinkTypeToMatch = function (_v0) {
	var match = _v0;
	return A2($elm$regex$Regex$contains, $dillonkearns$elm_markdown$Markdown$InlineParser$emailRegex, match.gt) ? $elm$core$Result$Ok(
		_Utils_update(
			match,
			{
				m: $dillonkearns$elm_markdown$Markdown$InlineParser$AutolinkType(
					_Utils_Tuple2(
						match.gt,
						'mailto:' + $dillonkearns$elm_markdown$Markdown$InlineParser$encodeUrl(match.gt)))
			})) : $elm$core$Result$Err(match);
};
					...
					$elm$parser$Parser$Advanced$succeed(
						F3(
							function (startOffset, htmlTag, endOffset) {
								return {dN: htmlTag, cT: endOffset - startOffset};
							})),
...
var $dillonkearns$elm_markdown$Markdown$InlineParser$isCodeTokenPair = F2(
	function (closeToken, openToken) {
		...
		if (!_v0.$) {
			if (!_v0.a) {
				var _v1 = _v0.a;
				return _Utils_eq(openToken.cT - 1, closeToken.cT);
			} else {
				var _v2 = _v0.a;
				return _Utils_eq(openToken.cT, closeToken.cT);
			}
		} else {
			return false;
		}
	...
	function (closeToken, openToken) {
		...
		if (_v0.$ === 7) {
			...
			if (_v1.$ === 7) {
				var closeChar = _v1.a;
				var close = _v1.b;
				return _Utils_eq(openChar, closeChar) ? ((_Utils_eq(open.b5, open.ck) || _Utils_eq(close.b5, close.ck)) ? (!(!A2($elm$core$Basics$modBy, 3, closeToken.cT + openToken.cT))) : true) : false;
			} else {
				return false;
			}
		} else {
	...
	function (closeToken, openToken) {
		var _v0 = function () {
			...
			if (_v1.$ === 10) {
				if (!_v1.a) {
					var _v2 = _v1.a;
					return _Utils_Tuple2(true, openToken.cT - 1);
				} else {
					var _v3 = _v1.a;
					return _Utils_Tuple2(true, openToken.cT);
				}
			} else {
		...
		var _v4 = function () {
			...
			if (_v5.$ === 10) {
				if (!_v5.a) {
					var _v6 = _v5.a;
					return _Utils_Tuple2(true, closeToken.cT - 1);
				} else {
					var _v7 = _v5.a;
					return _Utils_Tuple2(true, closeToken.cT);
				}
			} else {
				return _Utils_Tuple2(false, 0);
			}
...
var $dillonkearns$elm_markdown$Markdown$InlineParser$tokenToMatch = F2(
	function (token, type_) {
		return {h: token.a + token.cT, s: _List_Nil, j: token.a, gt: '', D: 0, u: 0, m: type_};
	});
...
var $dillonkearns$elm_markdown$Markdown$InlineParser$removeParsedAheadTokens = F2(
	function (_v0, tokensTail) {
		...
		return A2(
			$elm$core$List$filter,
			function (token) {
				return _Utils_cmp(token.a, match.h) > -1;
			},
			tokensTail);
	});
	...
	function (closeToken, matches, references, rawText, _v34) {
		...
		var updatedOpenToken = function () {
			...
			if ((!_v35.$) && (!_v35.a)) {
				...
				return _Utils_update(
					openToken,
					{a: openToken.a + 1, cT: openToken.cT - 1});
			} else {
				return openToken;
			}
		}();
	...
	function (remaining, tokens, matches, references, rawText) {
		...
		while (true) {
			if (!remaining.b) {
				...
				if (_v29.$ === 7) {
					var _char = _v29.a;
					var leftFringeRank = _v29.b.b5;
					var rightFringeRank = _v29.b.ck;
...
var $dillonkearns$elm_markdown$Markdown$InlineParser$emphasisToMatch = F5(
	function (references, rawText, closeToken, tokensTail, _v27) {
		...
		var remainLength = openToken.cT - closeToken.cT;
		var updt = (!remainLength) ? {bO: closeToken, bu: openToken, cf: remainTokens, cx: tokensTail} : ((remainLength > 0) ? {
			bO: closeToken,
			bu: _Utils_update(
				openToken,
				{a: openToken.a + remainLength, cT: closeToken.cT}),
			cf: A2(
				$elm$core$List$cons,
				_Utils_update(
					openToken,
			...
			cx: A2(
				...
				_Utils_update(
					closeToken,
					{a: closeToken.a + openToken.cT, cT: -remainLength}),
				tokensTail)
		});
		var match = A7(
			$dillonkearns$elm_markdown$Markdown$InlineParser$tokenPairToMatch,
			...
			$dillonkearns$elm_markdown$Markdown$InlineParser$EmphasisType(updt.bu.cT),
			updt.bu,
			updt.bO,
			$elm$core$List$reverse(innerTokens));
		return _Utils_Tuple3(updt.cx, match, updt.cf);
	});
...
var $dillonkearns$elm_markdown$Markdown$InlineParser$tokenPairToMatch = F7(
	function (references, rawText, processText, type_, openToken, closeToken, innerTokens) {
		var textStart = openToken.a + openToken.cT;
		var textEnd = closeToken.a;
		var text = processText(
			A3($elm$core$String$slice, textStart, textEnd, rawText));
		var start = openToken.a;
		var end = closeToken.a + closeToken.cT;
		var match = {h: end, s: _List_Nil, j: start, gt: text, D: textEnd, u: textStart, m: type_};
		var matches = A2(
			$elm$core$List$map,
			function (_v0) {
				var matchModel = _v0;
		...
		return {h: end, s: matches, j: start, gt: text, D: textEnd, u: textStart, m: type_};
	});
...
var $dillonkearns$elm_markdown$Parser$Token$backtick = A2(
	...
	'`',
	$elm$parser$Parser$Expecting('a \'`\''));
var $dillonkearns$elm_markdown$Markdown$CodeBlock$backtick = {bM: '`', b3: 0, cw: $dillonkearns$elm_markdown$Parser$Token$backtick};
	...
	function (minLength, fenceCharacter) {
		var builtTokens = A3(
			...
			A2(
				...
				minLength,
				$elm$parser$Parser$Advanced$token(fenceCharacter.cw)));
		return A2(
			$elm$parser$Parser$Advanced$mapChompedString,
			F2(
				function (str, _v0) {
...
var $dillonkearns$elm_markdown$Parser$Token$tilde = A2(
	...
	'~',
	$elm$parser$Parser$Expecting('a `~`'));
var $dillonkearns$elm_markdown$Markdown$CodeBlock$tilde = {bM: '~', b3: 1, cw: $dillonkearns$elm_markdown$Parser$Token$tilde};
			...
			$elm$parser$Parser$Advanced$succeed(
				F2(
					function (indent, _v0) {
						var character = _v0.a;
						var length = _v0.b;
						return {bN: character, cR: indent, cT: length};
					})),
...
var $elm$parser$Parser$Advanced$getSource = function (s) {
	return A3($elm$parser$Parser$Advanced$Good, false, s.da, s);
};
		...
		_List_fromArray(
			[
				...
				A2(
					...
					$elm$parser$Parser$Advanced$succeed(
						$elm$parser$Parser$Advanced$Done(body)),
					A2($dillonkearns$elm_markdown$Markdown$CodeBlock$closingFence, fence.cT, fence.bN))),
				A2(
				$elm$parser$Parser$Advanced$keeper,
				A2(
					$elm$parser$Parser$Advanced$keeper,
					A2(
						...
						$dillonkearns$elm_markdown$Markdown$CodeBlock$codeBlockLine(fence.cR)),
					$elm$parser$Parser$Advanced$getOffset),
...
var $elm$parser$Parser$Advanced$chompUntil = function (_v0) {
	...
	var expecting = _v0.b;
	return function (s) {
		var _v1 = A5($elm$parser$Parser$Advanced$findSubString, str, s.b, s.f6, s.dx, s.da);
		var newOffset = _v1.a;
		var newRow = _v1.b;
		var newCol = _v1.c;
		return _Utils_eq(newOffset, -1) ? A2(
...
var $elm$parser$Parser$Advanced$Located = F3(
	function (row, col, context) {
		return {dx: col, g: context, f6: row};
	});
var $elm$parser$Parser$Advanced$changeContext = F2(
	function (newContext, s) {
		return {dx: s.dx, g: newContext, cQ: s.cQ, b: s.b, f6: s.f6, da: s.da};
	});
		...
		return function (s0) {
			var _v1 = parse(
				A2(
					...
					A2(
						$elm$core$List$cons,
						A3($elm$parser$Parser$Advanced$Located, s0.f6, s0.dx, context),
						s0.g),
					s0));
			if (!_v1.$) {
				var p = _v1.a;
		...
		F2(
			function (delimiterText, revDelimiterColumns) {
				return A2(
					...
					{
						d7: delimiterText,
						ey: $elm$core$String$trim(delimiterText)
					},
					A2(
						$elm$core$List$map,
...
var $dillonkearns$elm_markdown$Markdown$Parser$unorderedListBlock = function () {
	var parseListItem = function (unparsedListItem) {
		if (!unparsedListItem.$) {
			...
			return {eX: body, dd: $elm$core$Maybe$Nothing};
		}
	};
	return A2(
		$elm$parser$Parser$Advanced$map,
...
var $dillonkearns$elm_markdown$Markdown$Parser$parseAllInlines = function (state) {
	return A3($dillonkearns$elm_markdown$Markdown$Parser$parseAllInlinesHelp, state, state.ab, _List_Nil);
};
	...
	function (state, rawBlocks, parsedBlocks) {
		...
		while (true) {
			if (rawBlocks.b) {
				...
				var _v13 = A2($dillonkearns$elm_markdown$Markdown$Parser$parseInlines, state.aB, rawBlock);
				switch (_v13.$) {
					case 1:
		...
		switch (rawBlock.$) {
			...
			case 3:
				...
				var parseItem = function (unparsed) {
					...
					var parsedInlines = A3($dillonkearns$elm_markdown$Markdown$Parser$parseRawInline, linkReferences, $elm$core$Basics$identity, unparsed.eX);
			...
			case 6:
				...
				return $dillonkearns$elm_markdown$Markdown$Parser$ParsedBlock(
					$dillonkearns$elm_markdown$Markdown$Block$CodeBlock(
						{eX: codeBlockBody, fz: $elm$core$Maybe$Nothing}));
			case 8:
				var _v9 = rawBlock.a;
				var header = _v9.a;
				var rows = _v9.b;
			...
			case 9:
				...
				return $dillonkearns$elm_markdown$Markdown$Parser$ParsedBlock(
					$dillonkearns$elm_markdown$Markdown$Block$Paragraph(
						A2($dillonkearns$elm_markdown$Markdown$Parser$inlineParseHelper, linkReferences, text.d7)));
			default:
				var raw = rawBlock.b;
				return $dillonkearns$elm_markdown$Markdown$Parser$ParsedBlock(
					$dillonkearns$elm_markdown$Markdown$Block$Paragraph(
	...
	return function (block) {
		switch (block.$) {
							...
							return renderer.fm(
								{
									e$: children,
									fB: level,
									f_: $dillonkearns$elm_markdown$Markdown$Block$extractInlineText(content)
								});
						},
			...
			case 7:
				...
				return $elm$core$Maybe$Just(
					$elm$core$Result$Ok(
						renderer.e0(codeBlock)));
			case 8:
				return $elm$core$Maybe$Just(
					$elm$core$Result$Ok(renderer.gu));
			case 3:
								...
								renderer.gr(
									A2(
										...
										function (_v5) {
											...
											var item = _v5.b;
											return A2(renderer.gq, maybeAlignment, item);
										},
										listListView))));
					},
					renderedHeaderCells);
...
var $dillonkearns$elm_markdown$Markdown$Renderer$renderSingleInline = F2(
	function (renderer, inline) {
		switch (inline.$) {
			...
			case 8:
				return $elm$core$Maybe$Just(
					$elm$core$Result$Ok(renderer.fk));
			default:
				var html = inline.a;
				if (!html.$) {
					var tag = html.a;
...
var $author$project$Element$Markdown$markdown = function (input) {
	return A2(
		$elm$core$Result$withDefault,
		_List_Nil,
		A2(
			$dillonkearns$elm_markdown$Markdown$Renderer$render,
			$author$project$Element$Markdown$markdownRenderer,
			A2(
				$elm$core$Result$withDefault,
				_List_Nil,
				$dillonkearns$elm_markdown$Markdown$Parser$parse(input))));
};
var $rtfeldman$elm_css$Css$paddingLeft = $rtfeldman$elm_css$Css$prop1('padding-left');
var $rtfeldman$elm_css$Css$paddingRight = $rtfeldman$elm_css$Css$prop1('padding-right');
var $rtfeldman$elm_css$Css$spaceBetween = $rtfeldman$elm_css$Css$prop1('space-between');
var $author$project$Element$Grid$grid = function (content) {
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$author$project$Style$Container$containerStyle,
						$author$project$Style$Center$centerStyle.dR,
						$author$project$Style$Theme$useDevice.a2(
						_List_fromArray(
							[
								$rtfeldman$elm_css$Css$flexDirection($rtfeldman$elm_css$Css$column)
						...
						return A2(
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$author$project$Element$Grid$gridItem,
											A2(
											$rtfeldman$elm_css$Css$padding2,
											$rtfeldman$elm_css$Css$px(0),
											$rtfeldman$elm_css$Css$px(15)),
							...
							$author$project$Element$Markdown$markdown(markdownContent));
					case 1:
						var assetContent = _v0.a;
						return A2(
							$rtfeldman$elm_css$Html$Styled$div,
							_List_fromArray(
								[
							...
							_List_fromArray(
								[
									A3(
									$author$project$Element$Asset$asset.dL,
									...
									_List_fromArray(
										[
											...
											$rtfeldman$elm_css$Css$pct(
												100 / $elm$core$List$length(columnContent))),
											$author$project$Style$Theme$useDevice.a2(
											_List_fromArray(
												[
													$rtfeldman$elm_css$Css$width(
									...
									switch (_v1.$) {
										case 0:
											...
											return A2(
												...
												$author$project$Element$Markdown$markdown(colMarkdown));
										case 1:
											var colAsset = _v1.a;
											return A2(
												$rtfeldman$elm_css$Html$Styled$div,
												...
												_List_fromArray(
													[
														A3(
														$author$project$Element$Asset$asset.dL,
														$elm$core$List$length(columnContent),
														colAsset,
														$elm$core$Maybe$Nothing)
													]));
										default:
											return $author$project$Element$Empty$emptyElement;
									}
								},
								columnContent));
					default:
...
var $author$project$Element$Hero$hero = function (content) {
	return A2(
		$rtfeldman$elm_css$Html$Styled$div,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						...
						$rtfeldman$elm_css$Css$px(30)),
						$rtfeldman$elm_css$Css$position($rtfeldman$elm_css$Css$relative),
						$rtfeldman$elm_css$Css$maxWidth($author$project$Style$Theme$useWidth.cz),
						A2(
						$rtfeldman$elm_css$Css$margin2,
						$rtfeldman$elm_css$Css$px(0),
						$rtfeldman$elm_css$Css$auto)
		...
		_List_fromArray(
			[
				A2(
				$author$project$Element$Asset$asset.dM,
				content.eT,
				$elm$core$Maybe$Just(
					_List_fromArray(
						[
...
var $author$project$Element$IFrame$iframe = function (content) {
	return A2(
		...
		_List_fromArray(
			[
				...
				$rtfeldman$elm_css$Html$Styled$Attributes$src(content.gf),
				$rtfeldman$elm_css$Html$Styled$Attributes$title(content.er)
			]),
		_List_Nil);
};
var $author$project$Content$View$contentView = function (maybeContents) {
	if (!maybeContents.$) {
		var cont = maybeContents.a;
		return A2(
			$elm$core$List$map,
			function (content) {
				var _v1 = content.ez;
				switch (_v1.$) {
					case 0:
						...
						return A2(
							...
							$author$project$Element$Markdown$markdown(markdownContent));
					case 1:
						var assetContent = _v1.a;
						return A2($author$project$Element$Asset$asset.e6, assetContent, $elm$core$Maybe$Nothing);
					case 2:
						var heroContent = _v1.a;
						return $author$project$Element$Hero$hero(heroContent);
					case 4:
						var gridContent = _v1.a;
						return $author$project$Element$Grid$grid(gridContent);
					case 3:
						var iframeContent = _v1.a;
						return $author$project$Element$IFrame$iframe(iframeContent);
					default:
						return $author$project$Element$Empty$emptyElement;
				}
			},
		...
		return _List_fromArray(
			[$author$project$Element$Empty$emptyElement]);
	}
};
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {w: fragment, S: host, fS: path, W: port_, X: protocol, x: query};
	});
...
var $rtfeldman$elm_css$Css$stringsToValue = function (list) {
	return $elm$core$List$isEmpty(list) ? {ez: 'none'} : {
		ez: A2(
			$elm$core$String$join,
			', ',
			A2(
...
var $author$project$Style$Theme$globalStyle = _List_fromArray(
	[
...
var $author$project$Style$Theme$useTheme = function (content) {
	return $rtfeldman$elm_css$Html$Styled$toUnstyled(
		A2(
			...
			$elm$core$List$concat(
				_List_fromArray(
					[$author$project$Style$Theme$globalStyle, content]))));
};
var $author$project$Preview$main = $elm$browser$Browser$element(
	{
				...
				return _Utils_Tuple2(
					function () {
						var _v4 = A2(
							...
							$dillonkearns$elm_pages$OptimizedDecoder$list($author$project$Content$Decoder$contentDecoder),
							payload);
						if (!_v4.$) {
							var decodedContent = _v4.a;
							return {bn: decodedContent};
						} else {
							return {bn: _List_Nil};
						}
					}(),
		...
		gC: function (decoded) {
			return $author$project$Style$Theme$useTheme(
				function () {
					var _v5 = decoded.bn;
					if (!_v5.b) {
						return _List_fromArray(
							[
								...
								_List_fromArray(
									[
										$rtfeldman$elm_css$Html$Styled$Attributes$css(
										_List_fromArray(
											[$author$project$Style$Container$containerStyle, $author$project$Style$Center$centerStyle.dy]))
									]),
								_List_fromArray(
									[
										A2(
										...
										_List_fromArray(
											[
												$rtfeldman$elm_css$Html$Styled$text('Esta página apenas deve ser usada no contexto da CMS.')
											])),
										A2(
										$rtfeldman$elm_css$Html$Styled$em,
										_List_Nil,
										_List_fromArray(
											[
												$rtfeldman$elm_css$Html$Styled$text('Por favor contacte o seu webmaster.')
											]))
									]))
							]);
					} else {
						var content = _v5;
						return $author$project$Content$View$contentView(
